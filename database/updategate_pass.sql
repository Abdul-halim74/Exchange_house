...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=4160454327ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=updategate_pass&table=users">`updategate_pass`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=updategate_pass&table=branches">`updategate_pass`.`branches`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=updategate_pass&table=departments">`updategate_pass`.`departments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=updategate_pass&table=visitors">`updategate_pass`.`visitors`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=updategate_pass&table=visitor_names">`updategate_pass`.`visitor_names`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gate_pass&table=users">`gate_pass`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gate_pass&table=visitors">`gate_pass`.`visitors`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gate_pass&table=departments">`gate_pass`.`departments`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gate_pass&table=branches">`gate_pass`.`branches`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=gate_pass&table=visitor_names">`gate_pass`.`visitor_names`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="56533435752a3f6b37594537535e5767">
