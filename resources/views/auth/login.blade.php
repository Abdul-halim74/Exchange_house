...
<head>
    ...
    <title>Gate Pass Management system | Log in</title>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('support_files/css/adminlte.css') }}">
</head>
<body class="hold-transition login-page">
    ...
    <!-- AdminLTE App -->
    <script src="{{ asset('support_files/js/adminlte.min.js') }}"></script>
</body>
</html>
