    ...
    <div class="container">
        ...
        <img style="margin-left:-10px;" src="{{asset('support_files/img/pdf_img/exc.PNG')}}" alt="Bank Logo"  />
            ...
            <p style="margin-left:5px;margin-top:-10px;">
                <div style="float:left;width:50%;margin-left:5px;"><span > Reference No.  </span> <span style="margin-left:90px;">:</span> <span style="margin-left:5px;">{{ $trnData->transaction_pin }} </span></div>
            ...
            <p style="margin-left:5px;">
                <div style="float:left;width:50%;margin-left:5px;"> <span >Cust. A/C No.  </span> <span style="margin-left:90px;">:</span> <span style="margin-left:5px;">  </span> </div>
                <div style="float:left;width:50%;margin-left:50px;"> <span style="">Cashier Name </span>  <span style="margin-left:45px;">:</span> <span style="margin-left:5px;">  </span> </div>
            </p>
        ...
        <div style="">
            ...
            <br>
            <p style="margin-left:5px;margin-top:-10px;">
                <div style="float:left;width:50%;margin-left:5px;"><span > Post Code  </span> <span style="margin-left:115px;">:</span> <span style="margin-left:5px;"> </span></div>
            ...
            <p style="margin-left:5px;margin-top:-10px;">
                ...
                <div style="float:left;width:50%;margin-left:50px;"><span style="">Gross Fees </span>  <span style="margin-left:85px;">:</span> <span style="margin-left:5px;"> </span> </div>
            </p>
            ...
            <p style="margin-left:5px;margin-top:-10px;">
                ...
                <div style="float:left;width:50%;margin-left:50px;"><span style="">VAT </span>  <span style="margin-left:125px;">:</span> <span style="margin-left:5px;"> </span> </div>
            </p>
            ...
            <p style="margin-left:5px;margin-top:-10px;">
                ...
                <div style="float:left;width:50%;margin-left:50px;"><span style="">Online Charge </span>  <span style="margin-left:65px;">:</span> <span style="margin-left:5px;"> </span> </div>
            </p>
            ...
            <p style="margin-left:5px;margin-top:-10px;">
                ...
                <div style="float:left;width:50%;margin-left:50px;"><span style="">Total Fees Received </span>  <span style="margin-left:30px;">:</span> <span style="margin-left:5px;"> </span> </div>
            </p>
            ...
            <p style="margin-left:5px;margin-top:-10px;">
                ...
                <div style="float:left;width:50%;margin-left:50px;"><span style="">Card Charge </span>  <span style="margin-left:80px;">:</span> <span style="margin-left:5px;"> </span> </div>
            </p>
            ...
            <p style="margin-left:5px;margin-top:-10px;">
                ...
                <div style="float:left;width:50%;margin-left:50px;"><span style="">Cash Amount </span>  <span style="margin-left:75px;">:</span> <span style="margin-left:5px;"> </span> </div>
            </p>
            ...
            <p style="margin-left:5px;margin-top:-10px;">
                ...
                <div style="float:left;width:50%;margin-left:50px;"><span style="font-size:16px;"><b>    Grand Total </b></span>  <span style="margin-left:80px;">:</span> <span style="margin-left:5px;"> </span> </div>
            </p>
            ...
            <p style="margin-left:5px;margin-top:-10px;">
                ...
                <div style="float:left;width:50%;margin-left:50px;"><span style="">  Paid By </span>  <span style="margin-left:115px;">:</span> <span style="margin-left:5px;"> </span> </div>
            </p>
            ...
            <p style="margin-left:5px;margin-top:-10px;">
                ...
                <div style="float:left;width:50%;margin-left:50px;"><span style=""> VAT Registration </span>  <span style="margin-left:50px;">:</span> <span style="margin-left:5px;"> </span> </div>
            </p>

            <br>
            <p style="margin-left:5px;margin-top:-10px;">
                <div style="float:left;width:50%;margin-left:5px;"><span style=""><b>  </b></span> <span style="margin-left:115px;"></span> <span style="margin-left:5px;"> </span></div>
                <div style="float:left;width:50%;margin-left:50px;"><span style=""> Tax Registration No</span>  <span style="margin-left:40px;">:</span> <span style="margin-left:5px;"> </span> </div>
            </p>
