                        ...
                        <form method="POST" enctype="multipart/form-data" action="{{ route('admin.customer_update') }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="{{ $customer->name }}" name="name" class="form-control" placeholder="Enter customer name" required />
                                                @error('name')
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" value="{{ $customer->dob }}" name="dob" class="form-control" />
                                                    @error('dob')
                                                    <span class="text-danger">{{ $message }}</span>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="country_id" class="form-control select2bs4" style="width: 100%;" required >
                                                    <option label="Select">--Select--</option>
                            ...
                            <div class="card card-info">
                                ...
                                <div class="card-footer">
                                    <button type="submit" class="btn custom_btn">Update Customer Info</button>
                                </div>
                            </div>
                        </form>
                    </div>
