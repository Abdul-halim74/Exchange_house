                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="nominee_dob" class="form-control" placeholder="Enter nominee date of birth" />
                                                @error('nominee_dob')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nominee_father_name" class="form-control" placeholder="Enter nominee father name" />
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="nominee_mother_name" class="form-control" placeholder="Enter nominee mother name" />
